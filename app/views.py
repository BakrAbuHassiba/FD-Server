from .models import Service, Project, News,Trianing
from .serializer import ServiceSerializer, ProjectSerializer, NewsSerializer,TrianingSerializer
...
class AllTrianings(generics.ListCreateAPIView):
    queryset = Trianing.objects.all()
    serializer_class = TrianingSerializer
